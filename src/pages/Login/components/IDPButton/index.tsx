...
const brandStyles: Record<string, { bg: string; hoverBg: string; border: string; color: string }> = {
  github: { bg: '#24292e', hoverBg: '#1b1f23', border: '#24292e', color: '#fff' },
  google: { bg: '#fff', hoverBg: '#f9fafb', border: '#e5e7eb', color: '#1a1a1a' },
  wechat: { bg: '#07c160', hoverBg: '#06ae56', border: '#07c160', color: '#fff' },
  feishu: { bg: '#3370ff', hoverBg: '#2860e6', border: '#3370ff', color: '#fff' },
  alipay: { bg: '#1677ff', hoverBg: '#0958d9', border: '#1677ff', color: '#fff' },
  douyin: { bg: '#000', hoverBg: '#1a1a1a', border: '#000', color: '#fff' },
  user: { bg: '#374151', hoverBg: '#1f2937', border: '#374151', color: '#fff' },
  staff: { bg: '#f97316', hoverBg: '#ea580c', border: '#f97316', color: '#fff' },
};
...
const IDPButton = ({
  ...
  const buttonContent = (
    <div style={{
      ...
      {loading ? (
        <Spin indicator={<LoadingOutlined spin style={{ fontSize: 20, color: brand.color }} />} />
      ) : IconComponent ? (
